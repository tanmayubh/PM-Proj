...
# Create a project
@router.post("/", response_model=ProjectResponse, response_model_exclude_none=True)
...
@router.get("/{project_id}/tasks", response_model=list[TaskResponse], response_model_exclude_none=True)
